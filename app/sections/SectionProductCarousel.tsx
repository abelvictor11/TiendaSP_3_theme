          ...
          <div className="lg:w-[30%] lg:shrink-0 flex flex-col justify-center">
            ...
            {cta_link?.value && (
              <div className="mt-8">
                <Link
                  to={cta_link.value}
                  className="inline-flex items-center justify-center px-8 py-3.5 text-sm font-medium text-white bg-slate-900 hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 rounded-md transition-colors"
                >
