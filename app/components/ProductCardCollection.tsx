...
const ProductCardCollection: FC<ProductCardCollectionProps> = ({
  ...
  return (
    <Link
      ...
      prefetch="viewport"
    >
      <div className="relative w-full aspect-w-16 aspect-h-12 sm:aspect-h-9 rounded-2xl overflow-hidden bg-[#F9F7F7] group">
        {/* Background image */}
        {image && (
          <Image
        ...
        {!image && (
          <div className="absolute inset-0 flex items-center justify-center bg-[#F9F7F7] rounded-2xl">
