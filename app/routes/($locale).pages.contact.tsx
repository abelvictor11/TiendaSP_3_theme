...
const STORE_LOCATIONS = [
  {city: 'Medellín', address: 'Carrera 43 #30-91'},
  {city: 'Barranquilla', address: 'Carrera 51B #93-25'},
  {city: 'Llanogrande', address: 'Km 4 Vía Rionegro'},
];

export async function loader({request}: LoaderFunctionArgs) {
  const seo = seoPayload.page({
    page: {title: 'Contacto', seo: {title: 'Contacto | Tienda N-Fitness', description: 'Contáctanos para cualquier consulta sobre nuestros productos de fitness y deporte. Sedes en Medellín, Barranquilla y Llanogrande.'}},
    url: request.url,
  });
  return json({seo});
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 mt-12 lg:mt-16">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="space-y-5">
                <a
                  href="mailto:ventasonline@tiendanfitness.com"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-600 group-hover:text-primary-600 transition-colors">
                      ventasonline@tiendanfitness.com
                    </p>
                  </div>
                </a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-secondary-800 mb-2">Nuestras sedes</p>
                    <div className="space-y-2">
                      {STORE_LOCATIONS.map((loc) => (
                        <div key={loc.city} className="text-sm text-neutral-600">
