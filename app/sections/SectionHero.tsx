...
export function SectionHero(props: SectionHeroFragment) {
  ...
  return (
    <div className="container px-4">
      <div className="nc-SectionHero aspect-h-16 aspect-w-10 relative overflow-hidden rounded-2xl bg-[#F9F7F7] sm:aspect-h-4 sm:aspect-w-3 lg:aspect-h-7 lg:aspect-w-16 2xl:aspect-w-16 2xl:aspect-h-7">
        {/* BG */}
        <div>
