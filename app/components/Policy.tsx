  ...
  const A_FEATURES = [
    {
      ...
      desc: 'Conoce nuestras tarifas de envío, tiempos de entrega y opciones de envío.',
    ...
    },
    {
      color: 'border-slate-200 dark:border-slate-700 border border-red-100',
      name: 'Cancelación',
      desc: 'Conoce cómo cancelar tu pedido, cuándo puedes cancelarlo y cómo solicitar una cancelación.',
      svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
