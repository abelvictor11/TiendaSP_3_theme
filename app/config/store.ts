...
export const storeConfig = {
  ...
  logoUrl:
    'https://cdn.shopify.com/s/files/1/0572/4710/5098/files/Logo_cyclewear_2026.svg?v=1774539777',

  /** Favicon URL — can be .svg, .png, or .ico */
  faviconUrl:
    'https://cdn.shopify.com/s/files/1/0572/4710/5098/files/favicon.png?v=1736453122',
