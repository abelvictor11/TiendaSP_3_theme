  ...
  const A_FEATURES = [
    {
      ...
      desc: 'Conoce nuestras tarifas de envío, tiempos de entrega y opciones de envío disponibles.',
    ...
    },
    {
      ...
      desc: 'Conoce nuestro proceso de devolución, requisitos y cómo solicitar una devolución.',
      svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      color: 'border-[#dacac7] dark:border-slate-700 border border-red-100',
      name: 'Cancelación',
      desc: 'Conoce cómo cancelar tu pedido, los plazos para cancelar y cómo solicitar una cancelación.',
      svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      desc: 'Conoce nuestro proceso de reembolso, requisitos y cómo solicitar un reembolso.',
      svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
